function post_family_tweaks__preset_configs() {
	...
	echo "PRESET_ROOT_PASSWORD=123123" >> "${SDCARD}"/root/.not_logged_in_yet

	# Preset username
	echo "PRESET_USER_NAME=pi" >> "${SDCARD}"/root/.not_logged_in_yet

	# Preset user password
	echo "PRESET_USER_PASSWORD=123123" >> "${SDCARD}"/root/.not_logged_in_yet

	# Preset user default realname
	echo "PRESET_DEFAULT_REALNAME=pi" >> "${SDCARD}"/root/.not_logged_in_yet
}
